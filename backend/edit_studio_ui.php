...
<body class="bg-light">
    <div class="container py-4">
        <div class="mb-4">
            <h1 class="h4 mb-1">Editar Estúdio</h1>
            <p class="text-muted mb-0">Atualizar informação do estúdio</p>
        </div>
        <form class="card shadow-sm p-4" method="post" action="edit_studio_post.php">
            <input type="hidden" name="studio_id" value="<?php echo $studio['studio_id']; ?>" />
            <div class="mb-3">
                <label class="form-label">Nome do Estúdio</label>
                <input class="form-control" placeholder="Nome do Estúdio" name="studio_name" value="<?php echo htmlspecialchars($studio['studio_name']); ?>" required>
            </div>
